...
<head>
     ...
     <title>Shope online | اضافة منتجات العناية بالبشرة</title>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <center>
        <div class="main">
            <form action="insert_skin_care.php" method="post" enctype="multipart/form-data">
                ...
                <br><br>
                <a href="products_skin_care.php">   عرض كل منتجات البشره </a>
            </form>
        </div>
